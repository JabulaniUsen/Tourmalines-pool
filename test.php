...
<html>
<head>
	<title>Tourmaline poll services</title>
...
<body>
	...
	<div class="container-fluid">
	  ...
	  <nav class="navbar navbar-default navbar-fixed-top" id="nav1" role="navigation">
       ...
       <div class="container-fluid" id="carat">
       <div id="carousel-id" class="carousel slide" data-ride="carousel">
       		...
       		<div class="item">
       			...
       			<div class="container">
       				<div class="carousel-caption" >
       					...
       					<p><a class="btn btn-lg btn-primary" href="#" role="button">Discover More</a></p>
       				</div>
       			</div>
       		</div>
       		<div class="item">
          ...
          <div id="sect6">
            <center><h1 style="font-weight: bold;">TESTIMONIALS</h1></center>
            <div id="carousel-id" class="carousel slide" data-ride="carousel">
              <ol class="carousel-indicators">
                <li data-target="#carousel-id" data-slide-to="0" class=""></li>
                <li data-target="#carousel-id" data-slide-to="1" class=""></li>
              ...
              <div class="carousel-inner">
                <div class="item">
                  <img data-src="holder.js/900x500/auto/#777:#7a7a7a/text:First slide" alt="First slide" src="sl6.jpg">
                  <div class="container">
                    <div class="carousel-caption">
                      <p>1. It was a great work done at my garden, your technicians impressed me and I can recommend your company to any one who need your services. Keep up the good work Tourmaline Services we forever greatful.<br> Mr. Jonah.</p>
              
                    </div>
                  </div>
                </div>
                <div class="item">
                  <img data-src="holder.js/900x500/auto/#666:#6a6a6a/text:Second slide" alt="Second slide" src="sl6.jpg">
                  <div class="container">
                    <div class="carousel-caption">
                      <p>2. You people really impressed me with great work done in my garden. Your technicians are well experience on this work at Umunze Anambra state.<br>Mr Bigger</p>
                     
                    </div>
                  </div>
                </div>
                <div class="item active">
                  <img data-src="holder.js/900x500/auto/#555:#5a5a5a/text:Third slide" alt="Third slide" src="sl6.jpg">
                  <div class="container">
                    <div class="carousel-caption">
                      <p>3. Hard works pays, with the help of good and experience technician. It was great having you guys handling my work at northern foreshore, lekki Lagos<br>
                     Mr. Nnamdi 
.                     </p>
        ...
        <div class="row">
          ...
          <div class="col-md-3">
            ...
            <p>Info@tourmalineservices.com.ng</p>
             <p>Admin@tourmalineservices.com.ng</p>
          </div>
        </div>
      </div>
    </section>
